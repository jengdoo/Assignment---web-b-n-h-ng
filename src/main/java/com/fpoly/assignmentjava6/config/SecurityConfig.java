package com.fpoly.assignmentjava6.config;

import com.fpoly.assignmentjava6.service.CustomUserDetailService;
...
//                .requestMatchers("/admin/**").hasAuthority("ADMIN")
    ...
    WebSecurityCustomizer webSecurityCustomizer(){
        return (web)->web.ignoring().requestMatchers("/static/**","/frontend/**","/backend/**","/image/**");
    }
